...
CREATE TABLE IF NOT EXISTS public.clientes (
    ...
    obriga_placa_venda BOOLEAN NOT NULL DEFAULT false,
    libera_veiculo_nao_cadastrado BOOLEAN NOT NULL DEFAULT false,
    obriga_km BOOLEAN NOT NULL DEFAULT false,
    controla_frota BOOLEAN NOT NULL DEFAULT false,
    obriga_autorizacao BOOLEAN NOT NULL DEFAULT false,
    envia_nfce_venda BOOLEAN NOT NULL DEFAULT false,
    obriga_motorista BOOLEAN NOT NULL DEFAULT false,
