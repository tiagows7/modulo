...
import { Settings, MonitorSmartphone, Users, Download } from "lucide-react";
...
const submenus = [
  {
    ...
    description: "TEF, terminal e numeração NFC-e / NF-e por filial",
  },
  {
    href: "/usuarios",
    label: "Usuários",
    icon: Users,
    description: "Acesso ao sistema e vínculo com filial",
  },
  {
    href: "/importa",
    label: "Importa Cadastros",
    icon: Download,
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      >
        ...
        <div>
          ...
          >
            Cadastro de PDV, usuários e importações do sistema
          </p>
        </div>
      </motion.div>
